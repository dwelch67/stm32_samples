...
for(rx=0;rx<2;rx++)
{
    ...
    //{
        ...
        //for(ra=0;ra<32;ra++) spi_data(0x55);
    //}
    //this DOES NOT...WHY?
    //for(y=0;y<64;y++)
    //{
        //for(ra=0;ra<16;ra++) spi_data(0xAA);
        //for(ra=0;ra<16;ra++) spi_data(0x55);
    //}
    //does not work right
    //for(y=0;y<32;y++)
    //{
    ...
    //for(y=0;y<64;y++)
    //{
        //for(ra=0;ra<16;ra++) spi_data(0xF0);
        //for(ra=0;ra<16;ra++) spi_data(0x0F);
    //}
